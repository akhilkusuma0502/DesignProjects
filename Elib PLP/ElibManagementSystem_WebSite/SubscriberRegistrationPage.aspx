<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubscriberRegistrationPage.aspx.cs" Inherits="ElibManagementSystem_WebSite.SubscriberRegistrationPage" %>
...
<body>
    ...
    <table>
        ...
        <tr>
            <td ></td>
            <td colspan="8">
                <asp:Label ID="lblMembershipFee" runat="server" Text="MemberShip Fee  :   Rs 1000 INR" ForeColor="Red"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        ...
        <tr>
            ...
            <td   colspan="3">
                ...
                <asp:DropDownList ID="ddlYearExpiration" runat="server" >
