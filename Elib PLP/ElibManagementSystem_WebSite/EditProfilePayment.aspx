<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditProfilePayment.aspx.cs" Inherits="ElibManagementSystem_WebSite.EditProfilePayment" %>
...
<body>
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style2">&nbsp;</td>
            <td class="auto-style2" colspan="6">
                <asp:Label ID="lblEditProfileMessage" runat="server"></asp:Label>
            </td>
            <td class="auto-style2" colspan="2">&nbsp;</td>
            <td class="auto-style2">&nbsp;</td>
        </tr>
